...
<li><a href="SearchResultDetails.jsp">Citation Details</a></li>
</ol>						
</div>					
</div>									
</nav>				<!-- HeaderEnd --> 			
...
<!-- Body For Host-Pathogen Search Options  -->
 <div><h1>Citation Details: Reference ID [1] </h1></div>

 <div>

<p>Miller, J.D., Strongman, D., Whitney, N.J. 1985. Observations on fungi associated with spruce budworm infested balsam fir needles. Canad. J. Forest Res. 15:896-901.</p>
<p>Search citation title in: <a href="http://scholar.google.ca/scholar?hl=en&q=Observations+on+fungi+associated+with+spruce+budworm+infested+balsam+fir+needles.&btnG=&as_sdt=1%2C5&as_sdtp=">Google Scholar</a>
</p>
