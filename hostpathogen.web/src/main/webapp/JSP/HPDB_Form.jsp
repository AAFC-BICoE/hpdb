		...
		<details class="span-8" open="open">
			...
			<div class="form-inline mrgn-tp-md" style="margin-top: 20px">
				...
				<select id="country" name="country" class="form-control mrgn-bttm-md">
						...
						<option label="Republic of Panama" value="Republic of Panama">Republic of Panama</option>
						...
						<option label="North America" value="North America">North America</option>
						<option label="Jamaica" value="Jamaica">Jamaica</option>
						<option label="Experimental Conditions" value="Experimental Conditions">Experimental Conditions</option>
...
<div class="versionF"
	...
	<span class="left">Host-Pathogen Database Version 1 |</span> <span
		class="right">&copy; 2014-2015 <a href="http://www.agr.gc.ca/">Agriculture
			& AgriFood Canada</a></span>
</div>
