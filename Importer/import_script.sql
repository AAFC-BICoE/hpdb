...
LOAD DATA INFILE '/home/bilkhus/Downloads/hostPathogenCsv/host_pathogens_PHCit22.csv' INTO TABLE hostPathogen character set 'utf8' FIELDS TERMINATED BY ',' ENCLOSED BY '"' LINES TERMINATED BY '\n' 
IGNORE 1 LINES 
