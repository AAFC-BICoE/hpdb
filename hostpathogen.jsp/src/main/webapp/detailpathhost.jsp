...
<!DOCTYPE html>
<!--[if IE 7]><html lang="en" class="no-js ie7"><![endif]--><!--[if IE 8]><html lang="en" class="no-js ie8"><![endif]--><!--[if gt IE 8]><!--><html class="no-js" lang="en">
<!--<![endif]-->
<head>
...
<script src="http://www5.agr.gc.ca/res/wet-boew3.0.6/dist/js/jquery.min.js"></script>
...
<!--[if gt IE 8]><!-->
<link href="http://www5.agr.gc.ca/res/wet-boew3.0.6/dist/grids/css/util-min.css" rel="stylesheet">
<link href="http://www5.agr.gc.ca/res/wet-boew3.0.6/dist/js/css/pe-ap-min.css" rel="stylesheet">
<link href="http://www5.agr.gc.ca/res/wet-boew3.0.6/dist/theme-gcwu-fegc/css/theme-min.css" rel="stylesheet">
<!--<![endif]-->
<noscript>
<link href="http://www5.agr.gc.ca/res/wet-boew3.0.6/dist/theme-gcwu-fegc/css/theme-ns-min.css" rel="stylesheet">
</noscript>
...
<script src="/acp/scripts/prototype.js"> </script><script src="/acp/scripts/scriptaculous.js"> </script><script src="/acp/scripts/stylesheetswitcher.js"> </script><script src="/acp/scripts/global.js"> </script>
</head>
<body>
<div id="wb-body">	
<div id="wb-skip">		
...
<li>
<a href="http://www.agr.gc.ca/eng/programs-and-services/list-of-programs-and-services/?id=1362151577626" target="_self">List of Programs and Services</a>
</li>
</ul>
</div>
<div class="clear"></div>
...
<!-- Body For Host-Pathogen Search Options  -->
 <div><h1>Fungal Full Search Records for:</h1>
  <p><h3>Abies balsamea</h3></p>
 </div>
<div>
 ...
 <div>
  <ul>
   <dl>
    <li>Aspergillus sp.</li>
     <ul>
      <li><a href="http://www.nrcresearchpress.com/doi/pdf/10.1139/x85-144?origin=publication_detail&">NB - Miller, J.D., Strongman, D., Whitney, N.J. 1985. Observations on fungi associated with spruce budworm infested balsam fir needles. Canad. J. Forest Res. 15:896-901.</a></li>
      <li>NB - Shields, J.K. 1969. Mycologia 61: 1165-1168.</li>
      <li>QC - Larsen, M.J., Lombard, F.F., Aho, P.E. 1979. Canad. J. Forest Res. 9: 31-38.</li>
     </ul>
    <li>Aspergillus fumigatus</li>
     <ul>
      <li>NB - Miller, J.D., Strongman, D., Whitney, N.J. 1985. Observations on fungi associated with spruce budworm infested balsam fir needles. Canad. J. Forest Res. 15:896-901.</li>
      <li>NB - Shields, J.K. 1969. Mycologia 61: 1165-1168.</li>
     </ul>
    ...
    <li>Aspergillus ochraceus</li>
     <ul>
      <li>ON - Groves, J.W. 1957. List of fungi isolated from seeds under the seedborne disease project. MS.</li>
     </ul>
    <li>Aspergillus parvulus</li>
     <ul>
      <li>NB - Miller, J.D., Strongman, D., Whitney, N.J. 1985. Observations on fungi associated with spruce budworm infested balsam fir needles. Canad. J. Forest Res. 15:896-901.</li>
     </ul>
   </dl>
...
<div>         
 <div>
  <span class="left">Host-Pathogen Database Version 1 |
   <a href="CVSLink"><span class="export csv">Export CSV</span></a>
  </span>
   <span class="right">&copy; 2014-2015 <a href="http://www.agr.gc.ca/">Agriculture & AgriFood Canada</a>
  </span>
 </div>
</div>
...
<!-- ScriptsStart --> 
<script src="http://www5.agr.gc.ca/res/wet-boew3.0.6/dist/theme-gcwu-fegc/js/theme-min.js"></script> <script src="http://www5.agr.gc.ca/res/wet-boew3.0.6/dist/js/settings.js"></script> <script src="http://www5.agr.gc.ca/res/wet-boew3.0.6/dist/js/pe-ap-min.js"></script>
</script>
 <!-- ScriptsEnd -->
</body>
</html>