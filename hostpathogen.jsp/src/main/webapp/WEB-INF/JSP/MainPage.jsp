						...
						<div class="container">
							...
							<form id="searchHostForm" action="" method="GET">
								...
								<details class="span-8" open="open">
									...
									<div class="form-inline" id="pathsearch"
										style="margin-top: 20px">
										<input id="toggle1" type="radio" name="pathogen"
											class="chkbox fungaldisplay" checked="checked"/> <label for="toggle1">&#160;&#160;Fungus/Bacteria/Nematode</label>
										<input id="toggle2" type="radio" name="pathogen"
								...
								<details class="span-8" open="open">
									...
									<div class="form-inline mrgn-tp-md" style="margin-top: 20px">
										...
										</span> <span id="provincedisplay" class="box"> <label
											class="col-sm-2 control-label wb-inv" for="form-select-md">Province:
										</label> <select class="form-control mrgn-bttm-md">
												<option label="" value=""></option>
												<option label="AB" value="AB">AB</option>
												<option label="BC" value="BC">BC</option>
