...
<!-- Body For Host-Pathogen Search Options  -->
  <div>
   <div id="PathogenSearchSection">
    <form action="GetSearchParameterMethodOfRequest.jsp" method="GET">
     <h3>Search by Pathogen</h3>
	Genus: <input type="text" name="pathgenus"/>
	Species: <input type="text" name="pathspecies"/>
	Virus MPLO Name: <input type="text" name="virusMPLO"/>
	Synonym off <input align="middle" type="checkbox" name="psynnonymOff"/>
  </div>

  <div id="HostSearchSection">
   <h3>Search by Host</h3>
	Family: <input type="text" name="hostfamily"/>
	Genus: <input type="text" name="hostgenus"/>
	Species: <input type="text" name="hostspecies"/>
	Synonym off <input align="right" type="checkbox" name="hsynnonymOff"/>
  </div>
   ...
   Country: 
    <input list="country" name="country">
     <datalist id="country">
  	...
  	<option value="Experimental Conditions">
  	<option value="Greenland">
  	<option value="Mexico">
     </datalist>
   Province/State:
    <input list="ProvinceState" name="provState">
     <datalist id="ProvinceState">
  	<option value="AB">
  	<option value="BC">
  	<option value="MB">
  	<option value="NB">
...
<div>
<span style="float:left"><input type="submit" value="Host-Pathogen Summary" onclick="SearchFunction()"></span>
<span style="float:middle"><input type="submit" value="Pathogen-Host Summary" onclick="SearchFunction()"></span>
</div>
</form>
</div>
...
function SearchFunction() {
    document.getElementById("PathogenSearchSection").submit();
}
</script>
 <!-- ScriptsEnd -->
</body>
