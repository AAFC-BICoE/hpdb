...
public class PersistentPasswordTokenManagerImpl implements PasswordTokenManager {
    ...
    /**
     * @see ca.gc.agr.mbb.hostpathogen.web.service.impl.PasswordTokenManager#generateRecoveryToken(ca.gc.agr.mbb.hostpathogen.web.model.User)
     */
    @Override
    ...
    /**
     * @see ca.gc.agr.mbb.hostpathogen.web.service.impl.PasswordTokenManager#isRecoveryTokenValid(ca.gc.agr.mbb.hostpathogen.web.model.User, java.lang.String)
     */
    @Override
    ...
    /**
     * 
     * @see ca.gc.agr.mbb.hostpathogen.web.service.impl.PasswordTokenManager#invalidateRecoveryToken(User, String)
     */
    @Override
